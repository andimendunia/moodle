...
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    // Enable "My Courses" for Behat/PHPUnit tests, disable for new production installs.
    // PHPUnit and Behat tests need enablemycourses=1 to avoid breaking tests.
    $enablemycoursesdefault = ((defined('PHPUNIT_TEST') && PHPUNIT_TEST) || defined('BEHAT_SITE_RUNNING')) ? 1 : 0;
