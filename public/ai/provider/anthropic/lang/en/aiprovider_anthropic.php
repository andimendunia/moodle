...
$string['privacy:metadata:aiprovider_anthropic:externalpurpose'] = 'This information is sent to the Anthropic Claude API in order for a response to be generated. Your Anthropic account settings may change how Anthropic stores and retains this data. No user data is explicitly sent to Anthropic or stored in Moodle LMS by this plugin.';
