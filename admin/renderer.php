...
class core_admin_renderer extends plugin_renderer_base {
     ...
     * @param string $moodlenetwarning MoodleNet deprecation warning message.
     *
     * @return string HTML to output.
     */
    public function admin_notifications_page($maturity, $insecuredataroot, $errorsdisplayed,
        ...
        $output .= $this->moodlenet_deprecation_warning($moodlenetwarning);
    ...
    /**
     * Display a warning about the deprecation of MoodleNet integration.
     *
     * @param string $moodlenetwarning The warning message
     * @return string HTML to output.
     */
    protected function moodlenet_deprecation_warning($moodlenetwarning) {
